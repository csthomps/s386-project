...
st.write("I will briefly describe the purpose and data behind each of the visualizations, but read the post for more details.")

st.write("This chart shows the distribution of the final differentials across all the games in my dataset.  Differentials are calculated as the home team's score minus the away team's score.  As you might expect, there are large spikes at the threes and sevens.  There also seems to be a majority of the observations on the positive side, which indicates that the home team wins more often.")
...
st.write("These visualizations are just a short summary of the work I have done for this project.  Here are some links if you want more details or background.")
